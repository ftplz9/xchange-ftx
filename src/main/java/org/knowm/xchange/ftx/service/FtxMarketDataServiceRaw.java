...
import org.knowm.xchange.ftx.dto.marketdata.FtxTickerDto;
...
public class FtxMarketDataServiceRaw extends FtxBaseService {
  ...
  public FtxResponse<FtxTickerDto> getFtxTicker(String market)
      throws FtxException, IOException {
    return ftx.getTickers(market, "300", null, null);
  }
}
